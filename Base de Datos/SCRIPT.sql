...
DROP PROCEDURE REZAGADOS.Insertar_Rol;
...
DROP PROCEDURE REZAGADOS.Agregar_Rol;
...
USE [GD1C2015]
GO
CREATE PROCEDURE REZAGADOS.Alta_Usuario (@Nombre VARCHAR(255))
AS
	BEGIN
...
USE [GD1C2015]
GO
CREATE PROCEDURE REZAGADOS.Insertar_Rol(@Nombre_Rol NVARCHAR(255), @Respuesta INT OUTPUT)
AS
BEGIN
...
GO
CREATE PROCEDURE REZAGADOS.Modificar_Rol(@Nombre_Rol VARCHAR(255), @Nombre_Viejo VARCHAR(255))
AS
BEGIN
...
GO
CREATE PROCEDURE REZAGADOS.Agregar_Rol (@Nombre_Usuario VARCHAR(255), @Nombre_Rol VARCHAR(255))
AS 
BEGIN 
BEGIN TRY
BEGIN TRANSACTION      
